...
public class OnlineGameActivity extends AppCompatActivity {
    ...
    void setEnableClick(boolean b) {
         ImageView iv;
         iv=(ImageView) findViewById(R.id.iv_11); iv.setClickable(b);
         iv=(ImageView) findViewById(R.id.iv_12); iv.setClickable(b);
         iv=(ImageView) findViewById(R.id.iv_13); iv.setClickable(b);

         iv=(ImageView) findViewById(R.id.iv_21); iv.setClickable(b);
         iv=(ImageView) findViewById(R.id.iv_22); iv.setClickable(b);
         iv=(ImageView) findViewById(R.id.iv_23); iv.setClickable(b);

         iv=(ImageView) findViewById(R.id.iv_31); iv.setClickable(b);
    ...
    private void CheckWinner() {
        ...
        if(winner!=0 && gameState==1){
            if(winner==1){
                showAlert(otherPlayer+" win's the game");
            }else if(winner==2){
